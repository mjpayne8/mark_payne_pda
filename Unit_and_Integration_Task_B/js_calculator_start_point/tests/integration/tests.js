...
describe('calculator functionality', function() {
  ...
  it('should update display of running total when number is pressed', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should update display of running total when operator is pressed', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should display a positive number', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number2')).click();
    element(by.css('#operator_add')).click();
    element(by.css('#number4')).click();
